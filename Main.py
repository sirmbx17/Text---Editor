...
class ToolBar(Label):
    def __init__(self, parent, *args, **kwargs):
        ...
        # Align Right Icon
        self.alignRightIcon = PhotoImage(file='Icons/align-right-26.png')
